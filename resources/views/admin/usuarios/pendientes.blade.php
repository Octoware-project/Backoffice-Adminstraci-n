...
@push('scripts')
    ...
    <script>
        {!! file_get_contents(resource_path('views/admin/usuarios/js/index.js')) !!}
    </script>
    <script>
        {!! file_get_contents(resource_path('views/admin/usuarios/js/partials/table-interactions.js')) !!}
    </script>
    <script>
