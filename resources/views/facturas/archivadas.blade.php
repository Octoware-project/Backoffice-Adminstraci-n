@extends('layouts.app')
<link rel="stylesheet" href="{{ asset('css/Facturas/Archivadas.css') }}">
@section('content')
...
<script>
    window.facturasUsuarioUrl = "{{ url('/facturas/usuario') }}";
</script>
<script src="{{ asset('js/Facturas/Archivadas.js') }}"></script>
